...
class _AddTaskWidgetState extends State<AddTaskWidget> {
  ...
  void initState() {
    ...
    _model.deatailsTextController ??= TextEditingController();
    _model.deatailsFocusNode ??= FocusNode();
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              width: double.infinity,
              child: TextFormField(
                controller: _model.deatailsTextController,
                focusNode: _model.deatailsFocusNode,
                autofocus: false,
                obscureText: false,
                decoration: InputDecoration(
                  isDense: true,
                ...
                cursorColor: FlutterFlowTheme.of(context).primaryText,
                validator:
                    _model.deatailsTextControllerValidator.asValidator(context),
              ),
            ),
            FFButtonWidget(
              onPressed: () async {
                await TasksRecord.collection.doc().set(createTasksRecordData(
                      ...
                      details: _model.deatailsTextController.text,
                      completed: false,
